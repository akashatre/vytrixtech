  ...
  <section id="about" className="section fade-up">
    <div className="grid md:grid-cols-2 gap-8 items-center">
      <div className="card">
        ...
        <p className="text-gray-300 mt-3">Founded by Akash, a developer who grew up seeing local businesses rely on paper and memory, Vytrixtech builds products that are practical, reliable and respectful of users' time.</p>
      </div>
      <div className="card">
